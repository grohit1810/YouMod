...
- (void)displaySectionsWithReloadingSectionControllerByRenderer:(id)renderer {
    ...
    NSLog(@"[YouMod] displaySectionsWithReloadingSectionControllerByRenderer elements: %s", sectionRenderers);
    for (id element in sectionRenderers) {
        NSLog(@"[YouMod] Element Class: %s", NSStringFromClass([element class]));
    }
    [self setValue:filteredArray(sectionRenderers) forKey:@"_sectionRenderers"];
    %orig;
}
- (void)addSectionsFromArray:(NSArray <YTIItemSectionRenderer *> *)array {
    NSLog(@"[YouMod] addSectionsFromArray elements: %s", array);
    for (id element in array) {
        NSLog(@"[YouMod] Section Element Class: %s", NSStringFromClass([element class]));
    }
